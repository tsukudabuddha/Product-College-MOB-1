...
func drawShape(sides: Int, sideLength: Int) {
    let degree = 180 - ((sides - 2) * 180 ) / sides
    for _ in 0..<sides {
...
func drawTriange(sideLength: Int) {
    drawShape(sides: 3, sideLength: sideLength)
}

func drawSqaure(sideLength: Int) {
    drawShape(sides: 4, sideLength: sideLength)
}

func drawPentagon(sideLength: Int) {
    drawShape(sides: 5, sideLength: sideLength)
}
