...
// 2
var maybePerson1: Person?
maybePerson1 = Person(name: "Andrew")
...
// 5
func newMyNameIs(person: Person?) -> String {
    switch person {
    case .none:
        return "This is not a valid person object"
...
print("\nNEW FUNCTION:")
print(newMyNameIs(person: maybePerson1))
print(newMyNameIs(person: maybePerson2))
